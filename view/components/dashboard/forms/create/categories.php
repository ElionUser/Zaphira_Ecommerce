<div class="col-xl-12 bg-white br-3 py-4">
    <form action="<?php echo helper::base_path().'/dashboard/categories/store'; ?>" method="post">
        <div class="row">
            <div class="form-group col-xl-10 mx-auto">
                ...
                <input name="name_categories" class="form-control">
                <small class="f-b2">Agregue aqui una nueva categoria</small>
                <hr>
